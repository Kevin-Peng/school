...
<body>
	...
	<div class="main">
		...
		<nav class="topNav navDelay">
			<ul>
				...
				<li>
					<div class="L1">
						<a href="#" class="gologin liAll">注册</a>
					</div>
				</li>
			</ul>
		</nav>
		<div id="login_part"
			style="background:url(static/img/back80.jpg)no-repeat; width:100%;height">
			<div id="login_detail">
				<h2>
					欢迎注册&nbsp;<a href="">IBeauty</a>
				</h2>
				<br />
				<form name="loginForm" action="regist.do" method="POST" >
					<dl>
						<dd>
							<input id="emailid" name="email" size="30" type="text"
								placeholder="请输入您的Email" value="" onblur="checkemail()">
							<div id="tips"
								style="position:relative;width:200px;color:red;left:750px;"></div>
						</dd>
						<br />
						<dd>
							<input id="nameid" name="nickname" size="30" type="text"
								placeholder="请输入您的用户名" onblur="checkname()">
							<div id="tips2"
								style="position:relative;width:200px;color:red;left:750px;"></div>
						</dd>
						<br />
						<dd>
							<input name="valild" size="15" type="text" placeholder="请输入验证码"
								id="emailId"> &nbsp;
							<button type="button" onclick="sendemail()">获取邮箱验证码</button>
						</dd>
						<br />
						<dd>
							<input id="pwd" name="pwd" size="30" type="password"
								placeholder="请输入您的密码">
						</dd>
						<br />
						<dd>
							<input id="spwd" name="spwd" size="30" type="password"
								placeholder="请确认您的密码" onkeyup="checkpwd()">
							<div id="tips3"
								style="position:relative;width:200px;color:red;left:750px;"></div>
						</dd>
						<dd>
						...
						<dd>
							...
							<p>
								<a href="help.html">我已看过并接受《用户协议》</a>
							</p>
						</dd>
						<br />
					</dl>
	...
	<script>
		function checkname() {
			var name = $("#nameid").val();
			$.ajax({
				url : 'checkName.do?nickname=' + name,
				async : true,
				success : function(data) {
					if (data == "N") {
						$("#tips2").text("用户名已被占用");
