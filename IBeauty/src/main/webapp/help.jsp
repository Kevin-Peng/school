...
<script type="text/javascript"
	src="./js/jquery-1.7.2.min.js?t=1496299121701"></script>
<script type="text/javascript"
	src="./js/jquery.bigautocomplete.js?t=1496299121701"></script>
<script type="text/javascript"
	src="./js/commonFooter.js?t=1496299121701"></script>
<style type="text/css">
#footer {
	position: relative;
}
	...
	<div class="main">
		<div class="header">
						...
						<ul>
							<li class="login_warp">
								<ul>
									...
									%>
									<li><a href="personal.do" title="" id="login_href">${user}</a></li>
			...
			<div id="header_bottom">
				<div id="header_bottom_mid">
					<div id="logo">
						<a href="index.jsp"> <span class="l_name"><img
					...
					<div class="search">
						...
						<div class="top_search">
							<a title="" href="search.do?keyword=保湿">保湿</a> <a title="" href="search.do?keyword=兰蔻">兰蔻</a> <a title=""
								href="search.do?keyword=雅诗兰黛">雅诗兰黛</a> <a title="" href="search.do?keyword=控油">控油</a> <a title="" href="search.do?keyword=去角质">去角质</a>
							<a title="" href="search.do?keyword=防晒">防晒</a> <a title="" href="search.do?keyword=减肥">减肥</a> <a title=""
						...
						<div class="cart">
							<ul>
								<li class="bag-li"><a href="./refresh.do" class="shopbag">
									...
									<%}else { %>
									 (<em>${cartcount.num}</em>)
									  </span> <span>：</span> <span class="bag_precie">￥${cartcount.price}</span> 
									  <% }%>
									<span
										class="bag_tips"></span>
								</a>
										...
										<div class="mycart_popup">
											...
											<div class="mycart_box">
												...
												<c:forEach var="cart"  items="${list1}">
													<li><div class="pic fl">
															<a target="_blank" href="/product/506019"><img
														...
														<div class="title fr">
															...
															<p>
																<a style="" href="/product/506019">规格 :
																	黑色套装 </a>
															</p>
															<p class="other">
				...
				<ul>
					...
					<li class="liSkin">
						...
						<div class="L2">
							...
							<div class="sortLast">
								<div class="hotimg">
									<a href="toDetail.do?productid=1000010"><img src="./static/img/skin-one.jpg"
										alt="Estee Lauder/雅诗兰黛 ANR即时特润修护眼部精华霜DNA眼霜15ml 小棕瓶 去细纹眼袋" /></a>
								</div>
								<div class="hotimg">
									<a href="toDetail.do?productid=1000011"><img src="./static/img/skin-two.jpg"
					...
					<li class="liMakeup">
						...
						<div class="L2">
							...
							<div class="sortLast">
								<div class="hotimg">
									<a href="toDetail.do?productid=1000012"><img src="./static/img/makeup-one.jpg"
										alt="Chanel/香奈儿 水亮系列口红可可小姐唇膏3g coco shine 轻盈滋润" /></a>
								</div>
								<div class="hotimg">
									<a href="toDetail.do?productid=1000013"><img src="./static/img/makeup-two.jpg"
					...
					<li class="liPerfume">
						...
						<div class="L2">
							...
							<div class="sortLast">
								<div class="hotimg">
									<a href="toDetail.do?productid=1000014"><img src="./static/img/perfume-one.jpg"
										alt="Burberry/巴宝莉 英伦迷情风格女士淡香水/女香30/50/100ml EDT" /></a>
								</div>
							</div>
							<div class="sortLast">
								<div class="hotimg">
									<a href="toDetail.do?productid=1000015"><img src="./static/img/perfume-two.jpg"
					...
					<li class="liBody">
						...
						<div class="L2">
							...
							<div class="sortLast">
								<div class="hotimg">
									<a href="toDetail.do?productid=1000016"><img src="./static/img/soma-one.jpg"
										alt="Clarins/娇韵诗 调和身体护理油100ml 紧实肌肤消除细纹" /></a>
								</div>
								<div class="hotimg">
									<a href="toDetail.do?productid=1000017"><img src="./static/img/soma-two.jpg"
					...
					<li class="liHair">
						...
						<div class="L2">
							...
							<div class="sortLast">
								<div class="hotimg">
									<a href="toDetail.do?productid=1000018"><img src="./static/img/hair-one.jpg"
					...
					<li class="liTool">
						...
						<div class="L2">
							...
							<div class="sortLast">
								<div class="hotimg">
									<a href="toDetail.do?productid=1000019"><img src="./static/img/tool-one.jpg"
										alt="MAC/魅可 #239 眼影刷/眼部阴影刷" /></a>
								</div>
								<div class="hotimg">
					...
					<li class="liMan">
						...
						<div class="L2">
							...
							<div class="sort sort-man">
								<div class="hotimg">
									<a href="toDetail.do?productid=1000021"><img src="./static/img/man-one.jpg"
		...
		<div id="context">
			<div id="left">
				...
				<div class="help_nav">
					<ul>
						<li><a href="FAQ.jsp" target="txt">帮助/FAQ</a></li>
						<li><a href="send.jsp" target="txt">配送服务</a></li>
						<li><a href="about.jsp" target="txt">关于我们</a></li>
						<li><a href="connect.jsp" target="txt">联系我们</a></li>
					</ul>
				</div>
			</div>
			<div id="right">
				<iframe src="./serve.jsp" name="txt" width="100%" height="100%"
